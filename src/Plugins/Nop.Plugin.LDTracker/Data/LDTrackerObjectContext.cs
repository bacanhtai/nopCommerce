...
{
    public class LDTrackerObjectContext : DbContext, IDbContext
    {
        public LDTrackerObjectContext(string nameOrConnectionString) : base(nameOrConnectionString) { }
        ...
        public void Install()
        {
            ...
            Database.SetInitializer<LDTrackerObjectContext>(null);
        ...
        {
            var dbScript = "DROP TABLE LotteryCategory";
